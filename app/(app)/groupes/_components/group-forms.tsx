    ...
    <div className="grid gap-3 sm:grid-cols-2">
      ...
      >
        ...
        <button
          type="submit"
          disabled={joining}
          className="press w-full rounded-lg border border-border bg-surface px-4 py-2 text-sm font-semibold transition-colors hover:border-border-strong disabled:opacity-60"
        >
          {joining ? "…" : "Rejoindre"}
        </button>
      </form>
